...
exports.post = async(req, res, next) => {
    ...
    contract.hasMinLen(req.body.endereço, 3, 'O endereço deve conter pelo menos 3 caracteres');
    ...
    try {
        ...
        // Salva a imagem
        await blobSvc.createBlockBlobFromText('room-images', filename, buffer, {
            contentType: type
        }, function (error, result, response) {
            if (error) {
                filename = 'default-room.png'
            }
        });
        ...
        await repository.create({
            ...
            active: true,
            tags: req.body.tags,
            image: 'https://www.decorfacil.com/wp-content/uploads/2019/03/20190322moveis-de-escritorio-62.jpg' + filename
        });
        res.status(201).send({
